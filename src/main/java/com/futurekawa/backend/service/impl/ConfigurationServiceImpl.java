        ...
        if (codePays.equalsIgnoreCase("BR")) {
            try {
                ...
                return ConfigurationResponse.builder()
                        ...
                        .tempMin(conf.getTemperatureIdeale().doubleValue() - conf.getTemperatureTolerance().doubleValue())
                        .tempMax(conf.getTemperatureIdeale().doubleValue() + conf.getTemperatureTolerance().doubleValue())
